...
function createPlaylistsHeader(divElement) {
...
function createArticles(div2Element, playlistsForCreate, i) {
...
function createTracksInfo(articleDiv3Elements, playlistsForCreate, i) {
...
function createTracks(articleElement, playlistsForCreate, i) {
...
function createPlaylists(playlistsForCreate) {
